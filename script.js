...
const CONFIG = {
  ...
  mapsUrl: "https://maps.app.goo.gl/bwpZb1rwpMSQdiAw5",
...
function spawnConfetti() {
  const colors = ["var(--gold)", "var(--sage)", "var(--gold-deep)", "var(--sage-deep)"];
  ...
  for (let i = 0; i < count; i++) {
    ...
    const ty = Math.sin(angle) * distance - 40; // leggera spinta verso l'alto
